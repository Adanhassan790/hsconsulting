...
# Cloudinary — persistent media storage for Railway (ephemeral filesystem)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@Hsconsultingke@gmail.com')
